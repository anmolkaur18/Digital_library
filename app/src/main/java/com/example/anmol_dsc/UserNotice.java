...
public class UserNotice extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        final ArrayAdapter<String> my_arrayAdapter = new ArrayAdapter<String>(UserNotice.this,android.R.layout.simple_list_item_1,array_notices);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if(firebaseAuth.getCurrentUser() == null){
                    startActivity(new Intent(UserNotice.this,MainActivity.class));
                }
            }
        };
